...
function getID(summonerName, region)
{
    var url = "https://" + region + ".api.riotgames.com" + "/lol/summoner/v4/summoners/by-name/" + summonerName + "?api_key=" + key;
